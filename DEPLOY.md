...
Copy-Item -Path dist -Destination C:\smart-invoice\backend\dist -Recurse -Force
Copy-Item -Path node_modules -Destination C:\smart-invoice\backend\node_modules -Recurse -Force
Copy-Item -Path package.json -Destination C:\smart-invoice\backend\ -Force
Copy-Item -Path ecosystem.config.js -Destination C:\smart-invoice\backend\ -Force
Copy-Item -Path tsconfig.json -Destination C:\smart-invoice\backend\ -Force
New-Item -ItemType Directory -Path C:\smart-invoice\backend\src\database -Force
Copy-Item -Path src\database\entities -Destination C:\smart-invoice\backend\src\database\entities -Recurse -Force
Copy-Item -Path src\database\migrations -Destination C:\smart-invoice\backend\src\database\migrations -Recurse -Force
